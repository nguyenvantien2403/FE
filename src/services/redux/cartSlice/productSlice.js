...
const initialState = {   //doi tuong luu tru trang thai ban dau
...
export const productSlice = createSlice({   //quan lý danh sach san pham trong gio hang 
  ...
  reducers: {
    ...
    addProductToCart: (state, action) => {  //them san pham trong gio hang
    ...
    deleteProductFromCart: (state, action) => {  //xoa san pham khoi gio hang
      const { id } = action.payload;
